...
-- Simple monotone white on black theme
local colors = {
  bg = "#000000",
  fg = "#ffffff",
  comment = "#808080",
...
function M.apply()
  ...
  -- Apply treesitter highlights (all white except comments and errors)
...
function M.setup()
  ...
  -- Set up autocmd to maintain theme after other colorschemes
