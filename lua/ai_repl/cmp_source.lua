...
function source:complete(params, callback)
  ...
  local local_cmds = {
    ...
    { label = "/start", detail = "Start AI session for current .chat buffer" },
    { label = "/init", detail = "Initialize AI session for current .chat buffer (alias for /start)" },
    ...
    { label = "/config", detail = "Show session config options picker" },
