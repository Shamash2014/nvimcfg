...
map("n", "<leader>pp", function()
  require("acp").show_sessions()
end, { desc = "Projects / worktrees" })
...
map("n", "<leader>oT", function()
  ...
  if cmd ~= "" then
    snacks().terminal(cmd, { win = { position = "right" } })
  end
...
-- ACP
map("n", "<leader>aw", function() require("acp.workbench").pick_project() end, { desc = "ACP new thread / projects" })
...
map("n", "<leader>aF", function() require("acp.workbench").pick_to_pin() end, { desc = "ACP pin multiple files" })
map("n", "<leader>ab", function() require("acp.workbench").push_open_buffers() end, { desc = "ACP pin open buffers" })
map("n", "<leader>aq", function() require("acp.workbench").push_quickfix() end, { desc = "ACP pin quickfix" })
...
map("v", "ga",  function() require("acp").trigger_visual() end,   { desc = "ACP visual" })
