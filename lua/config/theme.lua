...
local group = vim.api.nvim_create_augroup("nvim3-theme", { clear = true })
...
function M.apply()
  ...
  -- ACP transcript
  hl("AcpSectionHeader", { fg = p.strong, bold = true })
  hl("AcpDiffHeader", { fg = p.salient, bold = true })
  hl("AcpDiffAdd", { fg = p.add_fg, bg = p.add_bg })
  hl("AcpDiffDelete", { fg = p.del_fg, bg = p.del_bg })
  hl("AcpDiffHunk", { fg = p.strong, bg = p.bg1, bold = true })
